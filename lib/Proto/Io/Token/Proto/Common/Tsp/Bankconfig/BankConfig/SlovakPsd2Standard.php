...
/**
 * Generated from protobuf message <code>io.token.proto.common.tsp.bankconfig.BankConfig.SlovakPsd2Standard</code>
 */
class SlovakPsd2Standard extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>string tpp_client_id = 3;</code>
     */
    private $tpp_client_id = '';
    /**
     * Generated from protobuf field <code>string signing_key_id = 4;</code>
     */
     ...
     * @return $this
     */
    public function setTppClientId($var)
    {
        GPBUtil::checkString($var, True);
        $this->tpp_client_id = $var;
...
class_alias(SlovakPsd2Standard::class, \Io\Token\Proto\Common\Tsp\Bankconfig\BankConfig_SlovakPsd2Standard::class);
